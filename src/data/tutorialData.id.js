...
export const tutorialParts = [
  { id: 'part-1', number: '01', shortTitle: 'Persiapan proyek', title: 'Pengaturan Lantai dan Skala Gambar', summary: 'Bangun dasar proyek yang andal sebelum membuat elemen model.', workflow: ['Pengaturan', 'Impor', 'Skala', 'Verifikasi'], steps: [
    { id: 'create-project', title: 'Membuat atau Membuka Proyek TAS', duration: '4 menit', screenshot: null, intro: 'Mulai dengan informasi proyek yang sesuai dengan dokumen kontrak dan standar pengukuran.', instructions: ['Buat proyek TAS baru atau buka proyek yang sudah tersedia.', 'Periksa nama dan lokasi proyek agar file keluaran mudah dikenali.', 'Tinjau aturan perhitungan dan pastikan sesuai dengan persyaratan proyek.', 'Pastikan satuan proyek sudah benar sebelum mengimpor gambar.'], checks: ['Identitas proyek sudah benar', 'Aturan perhitungan sudah dikonfirmasi', 'Satuan sesuai dengan gambar sumber'] },
...
const actionDetails = {
  'create-project': [
    ...
    detail('Verifikasi satuan proyek', 'Konfirmasikan satuan metrik atau imperial sebelum mengimpor gambar agar TAS membaca setiap jarak dengan benar.', { title: 'Konfirmasi satuan proyek sebelum pemodelan', text: 'Satuan proyek menentukan cara jarak pada gambar impor diinterpretasikan. Mengubahnya setelah pemodelan dimulai dapat membuat dimensi dan kuantitas tidak valid.' }),
  ],
  'floor-settings': [
